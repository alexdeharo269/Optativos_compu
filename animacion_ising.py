...
def generate_animation(file_in, file_out): 
...
folder_path = 'ising_data'
output_folder = 'ising_gifs'
...
for file_name in files:
    ...
    file_number = os.path.splitext(file_name)[0].split('T')[1]
    print(file_name)

    # Set the input and output file paths
    file_in = os.path.join(folder_path, file_name)
    file_out = os.path.join(output_folder, f'isingT{file_number}')
    generate_animation(file_in, file_out)